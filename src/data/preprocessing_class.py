...
from src.data.preprocess_data import create_cleaned_token, number_punctuations_total, number_words, \
    number_unique_words, number_punctuation_marks, number_characters, number_pos, number_times, polarity, subjectivity, \
    number_stopwords, named_entities, sentence_embedding
...
class PreprocessingEuroParl:
    ...
    def preprocess_sentences_source(self, stopwords_source, nlp_source, textblob_source, embedding_matrix_source,
        ...
        self.dataframe["number_punctuations_total_source"] = number_punctuations_total(self.dataframe["text_source"])
        self.dataframe["number_words_source"] = number_words(self.dataframe["text_source"])
        self.dataframe["number_unique_words_source"] = number_unique_words(self.dataframe["text_source"])
        for punctuation_mark in self.punctuation_list:
            self.dataframe[f"number_{punctuation_mark}_source"] = number_punctuation_marks(self.dataframe[
                                                                                               "text_source"],
                                                                                           punctuation_mark)
        self.dataframe["number_characters_source"] = number_characters(self.dataframe["text_source"])
        ...
        self.dataframe["score_subjectivity_source"] = subjectivity(self.dataframe["text_source"],
                                                                   textblob_source)
        self.dataframe["number_stopwords_source"] = number_stopwords(self.dataframe["text_source"],
                                                                     stopwords_source)
    ...
    def preprocess_sentences_target(self, stopwords_target, nlp_target, textblob_target, embedding_matrix_target,
        ...
        self.dataframe["number_punctuations_total_target"] = number_punctuations_total(self.dataframe["text_target"])
        self.dataframe["number_words_target"] = number_words(self.dataframe["text_target"])
        self.dataframe["number_unique_words_target"] = number_unique_words(self.dataframe["text_target"])
        for punctuation_mark in self.punctuation_list:
            self.dataframe[f"number_{punctuation_mark}_target"] = number_punctuation_marks(self.dataframe[
                                                                                               "text_target"],
                                                                                           punctuation_mark)
        self.dataframe["number_characters_target"] = number_characters(self.dataframe["text_target"])
        for pos in self.pos_list:
        ...
        self.dataframe["score_subjectivity_target"] = subjectivity(self.dataframe["text_target"],
                                                                   textblob_target)
        self.dataframe["number_stopwords_target"] = number_stopwords(self.dataframe["text_target"],
                                                                     stopwords_target)
